...
class Ui_ChatBox(object):
    def setupUi(self, ChatBox):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(basedir,'logo.ico')), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        background = os.path.join(basedir,'backlogo.jpg').replace('\\','/')
        self.frame.setStyleSheet(f"border-image: url({background});")
        self.frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame.setObjectName("frame")
        self.lineEdit_3 = QtWidgets.QLineEdit(parent=ChatBox)
        self.lineEdit_3.setGeometry(QtCore.QRect(20, 240, 199, 31))
        self.lineEdit_3.setStatusTip("")
        self.lineEdit_3.setStyleSheet("border: 2px; border-radius: 10px;background-color: rgb(85, 85, 127);\n"
"color: rgb(255, 255, 255);")
        self.lineEdit_3.setText("")
        self.lineEdit_3.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.lineEdit_3.setCursorPosition(0)
        self.lineEdit_3.setPlaceholderText("Повторный пароль")
        ...
        self.lineEdit_2.setStyleSheet("border: 2px; border-radius: 10px;background-color: rgb(85, 85, 127);\n"
"color: rgb(255, 255, 255);")
        ...
        self.lineEdit.setStyleSheet("border: 2px; border-radius: 10px;background-color: rgb(85, 85, 127);\n"
"color: rgb(255, 255, 255);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 290, 199, 35))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, ChatBox):
        ...
        ChatBox.setWindowTitle(_translate("ChatBox", "ChatBox - Регистрация"))
        self.pushButton.setText(_translate("ChatBox", "Зарегистрироваться"))
        self.label.setText(_translate("ChatBox", "Уже есть аккаунт?"))
        self.label_2.setText(_translate("ChatBox", "Войти"))
